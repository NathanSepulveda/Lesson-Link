  ...
  render() {
    ...
    return (
      <React.Fragment>
        <div
          style={{ opacity: 1 }}
          className="page-component-wrapper row d-flex justify-content-center"
          id="HM"
        >
          <div className="page-component teacherhome col-md-6">
              ...
              <div id="search" className="">
                ...
                {this.props.students.filter(
                  s =>
                    Number(s.teacherId) ==
                    Number(sessionStorage.getItem("credentials"))
                ).length === 0 ? (
                  ""
                ) : (
                  <div className="search-section">
                    ...
                    >
                      {this.state.hasOwnProperty("selectedStudentId") ===
                      false ? (
                ...
                {this.props.parents.filter(
                  p =>
                    p.teacherId == Number(sessionStorage.getItem("credentials"))
                ).length === 0 ? (
                  ""
                ) : (
                  <div className="search-section">
                    <Input
                      ...
                      onChange={this.handleFieldChange}
                    >
                      {this.state.hasOwnProperty("selectedParentId") ===
                      false ? (
                    ...
                    {this.state.hasOwnProperty("selectedParentId") === false ? (
                      ...
                      <Link to={"/parents/" + this.state.selectedParentId}>
                        <Button
                          type="button"
                          className="btn btn-info tl-btn"
                          onClick={() => {
